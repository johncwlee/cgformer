...
model = dict(
    ...
    VoxFormer_head=dict(
        ...
        cross_transformer=dict(
           ...
           num_cams = _num_cams_,
           encoder=dict(
               type='VoxFormerEncoder_DFA3D_PE',
               ...
               transformerlayers=dict(
                   ...
                   attn_cfgs=[
                       dict(
                           type='DeformCrossAttention_DFA3D_PE',
                           pc_range=point_cloud_range,
                           num_cams=_num_cams_,
...
load_from='../../misc/cgformer/ckpts/efficientnet-seg-depth.pth'    #* change this