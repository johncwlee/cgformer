data_root = '/home/ßdata/semantickitti'    #* change this
ann_file = '/home/ßdata/semantickitti/labels'  #* change this
stereo_depth_root = '/home/ßdata/semantickitti/depth'  #* change this
camera_used = ['left']
...
model = dict(
    ...
    distillation_head=dict(
        ...
        data_config=data_config,
        point_cloud_range=point_cloud_range,
        embed_dims=[1280, 384, _dim_],
        feat_idx=1,
        occ_size=[128, 128, 16],
        class_frequencies=semantic_kitti_class_frequencies,
        num_samples=10000,
        image_distill=True,
        embed_dims_2d=[1280, 640, 640],
        loss_weight=1.0,
...
load_from='../../misc/cgformer/ckpts/efficientnet-seg-depth.pth'    #* change this to previous CGFormer checkpoint