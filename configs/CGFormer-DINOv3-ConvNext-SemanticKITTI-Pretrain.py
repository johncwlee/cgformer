...
seg_label_root = '/home/data/semantickitti/lidarseg'
...
#     backbone=dict(
#         type='Dinov3',
#         # ... your existing Dinov3 args and init_cfg ...
#     ),
# )
...
model = dict(
    ...
    img_backbone=dict(
        ...
        checkpoint='../../misc/cgformer/ckpts/dinov3_convnext_base_pretrain_lvd1689m-801f2ba9.pth'),   #* change this
    ),
    img_neck=dict(
        type='SECONDFPN',
